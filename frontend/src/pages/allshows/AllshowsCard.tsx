...
const toastIconError = <Bookmark className="w-6 h-6" style={{ marginRight: "20px", fill: "red" }} />;
const toastIconSuccess = <Bookmark className="w-6 h-6" style={{ marginRight: "20px", fill: "green" }} />;
const API_BASE_URL = import.meta.env.VITE_API_BASE_URL;
const AllShowsCard: React.FC<ShowCardProps> = ({ show, onShowDetails }) => {
  const fallbackImage =
